...
class Mutation():
    ...
    def mutation(individual):
        ...
        if (paramIndex == 1 or paramIndex == 2 or paramIndex == 3) and similitude[paramIndex] >1:
            similitude[paramIndex] = 2- similitude[paramIndex]
        elif(paramIndex == 1 or paramIndex == 2 or paramIndex == 3) and similitude[paramIndex] <0:
